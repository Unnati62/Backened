...
<title> Dream Bag : register</title>   
                    ...
                    <input type="hidden" name ="task" value="signup"/>
                        <div class="field-group">
                            ...
                            <div class="content-input-field">
                                <input name="first_name"  type="text" value="" placeholder="First Name" required="" style="font-weight: 600; color:black">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="last_name"  type="text" value="" placeholder="Last Name" required="" style="font-weight: 600; color:black">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="email"  type="email" value="" placeholder=" Email" required="" style="font-weight: 600; color:black">
                            </div>
                        </div>
                        <div class="field-group">

                            <div class="content-input-field">
                                <input name="mobile_number" type="text" value="" placeholder="Mobile Number" required="" style="font-weight: 600; color:black">
                            </div>
                        </div>
                         <div class="field-group">
                        
                         <div class="content-input-field">
                                <input name="address" type="text" value="" placeholder="Address" required="" style="font-weight: 600; color:black">
                            </div>
                        </div>
                        <div class="field-group">
                            <div class="content-input-field">
                                <input name="password"  type="Password" placeholder="Password" style="font-weight: 600; color:black">
                            </div>
                        </div>
                        <div class="content-input-field">
        ...
        <div class="container py-md-5">
            <div class="row">
                <div class="col-lg-3 footer_wthree_gridf mt-lg-5">
                    <h2><a href="home.jsp"><span>D</span>ream Bag
                        </a> </h2>
