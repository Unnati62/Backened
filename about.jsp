        ...
        <div class="container py-md-5">
            <div class="row grids-wthree-info">
                ...
                <div class="col-lg-6 ab-info-con ab-inf-page text-left">
                    <h4>About Our Dream Bag</h4>
                    <p>we have something for every occasion. Browse through our range of backpacks, handbags, totes, and more, meticulously designed to complement your lifestyle. Enjoy hassle-free shopping, secure transactions, and swift delivery. Elevate your accessory game today with us.</p>
                    <a href="single.jsp" class="btn shop mt-4">Read More</a>
                </div>
            </div>
